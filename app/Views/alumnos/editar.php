...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	curl_setopt_array($curl, array(
            CURLOPT_URL => "http://colibri.informaticapp.com/alumnos/".$_POST["idAlumno"],
    ...
    <div class="card shadow mb-4">
		...
		<form method="post" enctype="multipart/form-data" novalidate>
			...
			<div class="form-group col-md-6">
			    ...
			    <input type="text" name="nombrePadre" value="<?= $data["nombrePadre"]; ?>" class="form-control" id="nombrePadre" required>
			    <div class="valid-feedback">
				Esto est&aacute; bien
			    </div>
			    <div class="invalid-feedback">
			...
			<div class="form-group col-md-6">
			    ...
			    <input type="text" name="nombreMadre" value="<?= $data["nombreMadre"]; ?>" class="form-control" id="nombreMadre" required>
			    <div class="valid-feedback">
				Esto est&aacute; bien
			    </div>
			    <div class="invalid-feedback">
			...
			<div class="form-group col-md-4">
			    ...
			    <input type="text" class="form-control" value="<?= $data["dni"]; ?>" name="dni" id="dni" required  mixlength="8" maxlength="8" pattern="[0-9]{8}">
			    <div class="invalid-feedback">
