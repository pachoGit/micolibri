...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if ($data["Estado"] != 200)
    {
        ...
        echo "<script>alert('".$mensaje."');window.location.href = '". base_url().'/pagos/registrar_profesor'."';</script>";
    }
    $mensaje = $data["Detalles"];
    // Redireccion despues de insertar
    echo "<script>alert('".$mensaje."');window.location.href = '". base_url().'/pagos/listar_profesores'."';</script>";
}
...
$profesores = $profesores['Detalles'];
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
		...
		<form  method="post" class="needs-validation" novalidate>
		    ...
		    <a href="<?php echo base_url().'/pagos/listar_profesores'?>" class="btn btn-danger mt-4">Cancelar</a>
		</form>
