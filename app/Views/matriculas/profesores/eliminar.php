...
curl_setopt_array($curl, array(
    CURLOPT_URL => "http://colibri.informaticapp.com/curSecPorProfesor/".$id,
...
foreach ($datos as $eliminado)
{
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "http://colibri.informaticapp.com/curSecPorProfesor/".$eliminado["idCurSecPorProfesor"],
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
