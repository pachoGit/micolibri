...
<script type="text/javascript">
 ...
 {
     let alumnos = JSON.parse(respuesta);
     let i;
     let tbody = "";
     let cuerpo = document.getElementById("tabla").getElementsByTagName("tbody")[0];
     let nuevaFila;
     let total = document.getElementById("total").innerHTML = alumnos.length;
	 ...
	 tbody += "<tr>";
	 tbody += "<td>" + alumnos[i].nombres  + "</td>";
	 tbody += "<td>" + alumnos[i].apellidos + "</td>";
	 tbody += "<td>" + alumnos[i].dni + "</td>";
	 tbody += "<td>" + alumnos[i].edad + "</td>";
	 tbody += "</tr>";
 ...
 function buscar()
 {
     ...
     ruta = "http://colibri.informaticapp.com/funcsAjax/reporte_alumnos";
...
<div class="container-fluid" id="pag-pdf">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Reportes de alumnos</h6>
        </div>
        <div class="card-body">
